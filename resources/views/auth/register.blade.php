                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form method="POST" action="{{ route('register') }}" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="surname" placeholder="{{ __('Sobrenome') }}" value="{{ old('surname') }}" required>
                                    </div>

                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="cpf_cnpj" placeholder="{{ __('CPF/CNPJ') }}" value="{{ old('cpf_cnpj') }}" required>
                                    </div>

                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="cellphone" placeholder="{{ __('Celular') }}" value="{{ old('cellphone') }}" required>
                                    </div>
